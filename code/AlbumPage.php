...
class AlbumPage_Image extends DataObject
{
	...
	public function getCMSFields()
	{
		...
		$fields->addFieldToTab('Root.Main', UploadField::create("FullsizeImage", "Image")->setAllowedFileCategories('image') );
		$fields->addFieldToTab('Root.Main', TextField::create("Alt","Image Alt Tag"));
		$fields->addFieldToTab('Root.Main', TextField::create("Title"));
		$fields->addFieldToTab('Root.Main', HTMLEditorField::create("Description"));
		
		$fields->addFieldToTab('Root.Metadata', TextField::create("MetaTitle","Meta Title"));
		$fields->addFieldToTab('Root.Metadata', TextField::create("MetaKeywords","Meta Keywords"));
		$fields->addFieldToTab('Root.Metadata', TextAreaField::create("MetaDescription","Meta Description"));
